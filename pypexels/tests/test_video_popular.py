...
#
#      File: test_video_popular.py
#
#    Author: Salvatore Ventura <salvoventura@gmail.com>
#      Date: 08 May 2020
#   Purpose: Unit Test for Video Popular()
#
#  Revision: 1
...
class TestVideoPopular:
    ...
    store_mapping = {
        'popularvideo': os.sep.join(
            [root_path, 'pypexels', 'tests', 'resources',
             'resource__videos_popular_per_page_5_page_2.json']),
    }
